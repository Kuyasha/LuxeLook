...
const Add = ({token}) =>{
    ...
    const onSubmitHandler = async(e) => {
        ...
        try{
            ...
            //if we upload one img of any pdt;then we dont compulsorily need to upload others
        ...
        <form onSubmit={onSubmitHandler} className="flex flex-col w-full items-start gap-3">
            ...
            <div>
                ...
                <div className="flex gap-3"> 
                    {/*If S is already available in sizes then remove it,else add it using spread;
                    if we click on any size then its bg-color will be pink else slate */}
